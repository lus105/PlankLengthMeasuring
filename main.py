...
def main():
    ...
    for name in image_paths:
        ...
        image_test = cv2.imread('dataset/results/1seg.png', cv2.IMREAD_GRAYSCALE)
        ...
        contours = process.find_contours(image_test, cfg.cnt_min_per)
        contours_img = process.vertical_scan(image_test.shape, contours, cfg.scan_offset, cfg.scan_stride)
        #cv2.imwrite(cfg.results + file_name + 'seg.png', mask_th)
